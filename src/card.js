...
function Card(props) {
    ...
    const fetchData = () => {
      ...
      return( axios.request(
        ...
        setUser(response.data.number+" is " +response.data.text);
      }).catch(function (error) {
        console.error(error);
      }))
      
    //   axios.get(`http://numbersapi.com/random/${props.fact}`)
...
// });
    ...
    return(
       ...
       <div className='card col col-lg-3 col-md-4 col-sm-6 col-12 container h-200'>
